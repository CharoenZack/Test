...
<body>
	...
	<div class ="container">
		<div class="card">
			<h4 class="card-header"> เพิ่ม ลบ แก้ไขข้อมูล</h4>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<div class="row">
								<div class="col">
									<a href="<?= base_url("index.php/welcome/index/{$row->id}") ?>" class="btn btn-warning btn-block btn-sm">
										แก้ไข
									</a>
								</div>
								<div class="col">
									<a onclick="return confirm('คุณต้องการจะลบข้อมูลนี้จริงหรือ?')" href="<?= base_url("index.php/welcome/delete/{$row->id}") ?>" class="btn btn-danger btn-block btn-sm">
										ลบ
									</a>
								</div>
							</div>
